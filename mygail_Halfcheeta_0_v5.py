...
class Ppo:
    def __init__(self, N_S, N_A):
        ...
        self.scheduler_actor = torch.optim.lr_scheduler.StepLR(self.actor_optim,step_size=2, gamma=0.9999)
        self.scheduler_critic = torch.optim.lr_scheduler.StepLR(self.critic_optim,step_size=2, gamma=0.9999)
    def scheduler(self):
...
reward_src_list = []
overall_acc_list = []
memory_expert = sample_expert_data_target(expert,memory_expert,BrokenJointEnv(gym.make('HalfCheetah-v2'),[0]))
memory_expert = sample_expert_data_target(expert,memory_expert,BrokenJointEnv(gym.make('HalfCheetah-v2'),[]))
memory_expert = deque()
...
np.savetxt('savefile/Half0eval_r_break_0_3_v5.txt',eval_reward_list)
np.savetxt('savefile/Half0src_r_break_0_3_v5.txt',reward_src_list)
np.savetxt('savefile/Half0acc_learner_v5.txt',acc_learner_list)
np.savetxt('savefile/Half0acc_expert_v5.txt',acc_expert_list)
np.savetxt('savefile/Half0acc_overall_v5.txt',overall_acc_list)
