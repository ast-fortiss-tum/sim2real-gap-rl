...
def main():
    ...
    sac_loss_logger = SACLossLogger(log_dir="./sac_losses_tensorboard_pc/", verbose=1)
    checkpoint_callback = CheckpointCallback(
        save_freq=50000,
        save_path='./sac_donkeycar_checkpoints_pc/',
    ...
    checkpoint_path = "./sac_donkeycar_checkpoints_pc/(fill).zip"
    ...
    try:
        ...
        model = SAC(
            ...
            seed=seed,
            device="auto",
            tensorboard_log="./sac_donkeycar_tensorboard_pc/",
        )
