...
class DARC_SB3(SAC):
    ...
    def __init__(self,
                 ...
                 n_eval: int = 10,         # Evaluate every n_eval episodes.
                 **kwargs):
        """
    ...
    def evaluate_episode(self, deterministic=True):
        """
    ...
    def train(self):
        ...
        if done:
            ...
            # Every n_eval episodes, run an evaluation episode.
            if self.num_episodes % self.n_eval == 0:
                eval_steps, eval_reward = self.evaluate_episode(deterministic=True)
                print("EVALUATION: SOURCE: index: {}, steps: {}, total_rewards: {}".format(self.num_episodes,
                                                                                            eval_steps,
                                                                                            eval_reward))
                self.tb_writer.add_scalar("evaluation/source_episode_reward", eval_reward, self.num_episodes)
