...
class DARC_SB3(SAC):
    ...
    def __init__(self,
        ...
        # Create a unique log directory for this run (e.g. using a timestamp).
    ...
    def learn(self, total_timesteps: int, log_interval: int = 100, **kwargs):
        ...
        Also saves a model checkpoint every 1000 timesteps.
        ...
        while timesteps < total_timesteps:
            ...
            # Save a checkpoint every 1000 timesteps.
            if timesteps % 1000 == 0:
