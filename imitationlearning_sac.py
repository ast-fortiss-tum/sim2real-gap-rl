...
IL = GailContSAC(policy_config, value_config,  target_env, device,expert_traj, ent_adj=True, n_updates_per_train=1,
        batch_size=256,lr = 5e-5,max_steps = args.episode_length,running_mean=model.running_mean,warmup_games=800,eval_step = False)

IL.train(10000, deterministic=False)
